...
def class_assignment(request):
    ...
    return render(request, 'classroom/class_assignment.html', {'student': student, 'assignment_list': assignment_list, 'currentDateTime': currentDateTime})
...
def submit_assignment(request, id=None):
    ...
    if CurrentDate > ExpectedDate:
        ...
        # messages.warning(request, "Sorry, Deadline exceeded!")
        # print("Date missed")
